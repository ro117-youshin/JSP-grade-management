...
<BODY>
   <%
      ...
      ResultSet rset1 = stmt1.executeQuery("select *, (select count(*)+1 from examtable as a where (a.kor+a.eng+a.mat) > (b.kor+b.eng+b.mat)) from examtable as b;");
   ...
   <%
      ...
      // ##1. 페이지 번호
      out.println("<h1>"+"테이블 전체 데이터 조회<br>" + "현재 페이지 : "+currentPage+"</h1>");
